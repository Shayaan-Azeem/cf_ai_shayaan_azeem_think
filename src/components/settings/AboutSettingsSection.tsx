    ...
    <div className="space-y-8 py-8">
      ...
      <section className="pb-2">
        ...
        <p className="text-sm text-text-muted mb-4">
          You are currently using Think v{appVersion || "..."}
        </p>
        <Button
      ...
      <section className="pb-2">
        ...
        <p className="text-sm text-text-muted mb-4">
          ...
          <button
            onClick={() => handleOpenUrl("https://www.ericli.io/think")}
        ...
        <div className="flex items-center gap-1">
          <Button
            onClick={() => handleOpenUrl("https://github.com/erictli/think")}
            variant="outline"
            size="md"
            className="gap-1.25"
          >
          ...
          <Button
            onClick={() =>
              handleOpenUrl("https://github.com/erictli/think/issues")
            }
            variant="ghost"
            size="md"
